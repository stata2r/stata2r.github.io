...
arrow::write_dataset(
  dat, 
  path = "flights14",
  partitioning = c("origin") # <-- NB: partition your data by the main grouping vars for efficiency
)
```
